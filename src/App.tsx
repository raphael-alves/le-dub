...
function App() {
	...
	return (
		// biome-ignore lint/a11y/noStaticElementInteractions: <Done on purpose here>
		// biome-ignore lint/a11y/useKeyWithClickEvents: <Done on purpose here>
		<div className='dub-container' onClick={handleClick}>
